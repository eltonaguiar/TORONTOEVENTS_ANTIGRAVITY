                ...
                >
                    ...
                    <nav className="flex-1 overflow-y-auto custom-scrollbar p-4 space-y-2">
                        ...
                        <div className="space-y-1 pt-4 border-t border-white/5">
                            ...
                            <a
                                href="/2xko"
                                className="w-full text-left px-4 py-3 rounded-xl flex items-center gap-3 hover:bg-purple-500/20 text-purple-200 hover:text-white transition-all border border-transparent hover:border-purple-500/30 overflow-hidden"
                                onClick={() => setIsOpen(false)}
                            >
